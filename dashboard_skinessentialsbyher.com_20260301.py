...
Run with: streamlit run dashboard_skinessentialsbyher.com_20260301.py
"""
...
# Title
st.title("📊 skinessentialsbyher.com Analytics Dashboard")
st.markdown(
...
gsc = {
    ...
    "top_queries": [
        ...
        {
            "keys": ["her skin essentials products philippines"],
            "clicks": 0,
            "impressions": 1,
            "ctr": 0,
            "position": 28,
...
gsc_recs = [
    {
        ...
        "description": "Average position 8.7 needs improvement. Target top 5 positions for better CTR.",
    },
    {
        "priority": "Medium",
        "title": "Increase Content Volume",
        "description": "Only 3 queries with clicks. Create more content around relevant keywords.",
    },
    {
        "priority": "Low",
        "title": "Build Backlinks",
        "description": "Acquire quality backlinks to improve domain authority.",
    },
]
...
ga4_recs = [
    {
        ...
        "description": "58% bounce rate is high. Improve page load speed and content relevance.",
    },
    {
        "priority": "Medium",
        "title": "Add Conversion Tracking",
        "description": "Set up goals to track user actions like purchases or signups.",
    },
    {
        "priority": "Low",
        "title": "Increase Engagement",
        "description": "Add interactive elements and improve user experience.",
    },
]
...
meta_recs = [
    {
        ...
        "description": "Post 3-5 times per week to maintain engagement.",
    },
    {
        "priority": "Low",
        "title": "Create More Video Content",
        "description": "Videos typically get higher engagement rates.",
    },
]
...
with col_m1:
    st.metric("Impressions", "351,991")
with col_m2:
    st.metric("Page Fans", "61,892")
with col_m3:
...
with col_m4:
    st.metric("Avg Daily Impressions", "50,284")
