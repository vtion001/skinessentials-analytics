...
def load_data():
    ...
    report_file = DATA_DIR / "data_report_skinessentialsbyher.com_20260301.json"
...
st.markdown(
    f"**Report Period:** February 23-28, 2026 | **Generated:** {datetime.now().strftime('%Y-%m-%d %H:%M')}"
)
...
ga4_prop_id = os.getenv("GA4_PROPERTY_ID")
