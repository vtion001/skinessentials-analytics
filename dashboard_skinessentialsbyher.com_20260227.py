...
Run with: streamlit run dashboard_skinessentialsbyher.com_20260227.py
"""
...
with col2:
    st.metric("Search Visibility", "28.9/100")

with col3:
    st.metric("GA4 Performance", "48.1/100")
...
with col_g2:
    st.metric("Total Impressions", "41")
with col_g3:
