"""
Streamlit Dashboard - --help
Auto-generated by Data Analyst Agent

Run with: streamlit run dashboard_--help_20260228.py
"""
...
# Page config
st.set_page_config(
    page_title="--help Analytics Dashboard", page_icon="📊", layout="wide"
)
...
# Title
st.title("📊 --help Analytics Dashboard")
st.markdown(
...
with col2:
    st.metric("Search Visibility", "50.0/100")

with col3:
    st.metric("GA4 Performance", "45.0/100")
